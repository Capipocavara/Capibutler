...
namespace Capibutler.Editor.Utils
{
    ...
    {
        private const string PlayModeMenu = "Capipocavara/Enter PlayMode on StartUp scene #p";
        private const string PlayModeOverride = "Capipocavara/Default PlayMode on StartUp scene";
